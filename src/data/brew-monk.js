...
export var BIS = [
  { slot: "머리", simcSlot: "head", en: "Fetid Vilecrown", ko: "악취 나는 부정왕관", id: 251177, dungeon: "Magisters' Terrace", stats: ["crit","vers"] },
  { slot: "목", simcSlot: "neck", en: "Pendant of Aching Grief", ko: "괴로운 비탄의 펜던트", id: 251096, dungeon: "Windrunner Spire", stats: ["haste","vers"] },
  { slot: "어깨", simcSlot: "shoulder", en: "Twilight's Edge Spaulders", ko: "황혼의 서슬 어깨덮개", id: 151319, dungeon: "Seat of the Triumvirate", stats: ["crit","mastery"] },
  ...
  { slot: "손목", simcSlot: "wrist", en: "Custodial Cuffs", ko: "관리인의 소매장식", id: 251103, dungeon: "Magisters' Terrace", stats: ["haste","vers"] },
  { slot: "장갑", simcSlot: "hands", en: "Ruby Contestant's Gloves", ko: "루비 참가자의 장갑", id: 193721, dungeon: "Algeth'ar Academy", stats: ["mastery","vers"] },
  { slot: "허리", simcSlot: "waist", en: "Snapvine Cinch", ko: "치악덩굴 허리끈", id: 251082, dungeon: "Windrunner Spire", stats: ["crit","mastery"] },
  { slot: "다리", simcSlot: "legs", en: "Shifting Stalker Hide Pants", ko: "변화의 추적자 가죽 바지", id: 151314, dungeon: "Seat of the Triumvirate", stats: ["mastery","vers"] },
  { slot: "발", simcSlot: "feet", en: "Footpads of Seeping Dread", ko: "스며드는 공포의 발보호구", id: 151317, dungeon: "Seat of the Triumvirate", stats: ["mastery","vers"] },
  ...
  { slot: "무기", simcSlot: "main_hand", en: "Obsidian Goaltending Spire", ko: "흑요석 골대지킴이 뾰족지팡이", id: 193723, dungeon: "Algeth'ar Academy", stats: ["crit","vers"] },
];
...
export var ALTS = [
  ...
  { forSlot: "발", id: 251121, en: "Domanaar's Dire Treads", ko: "도마나르의 광포한 발보호대", dungeon: "Magisters' Terrace", stats: ["mastery","vers"] },
];
