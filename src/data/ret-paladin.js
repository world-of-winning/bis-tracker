...
export var BIS = [
  { slot: "head", en: "Luminant Verdict's Unwavering Gaze", ko: "빛나는 선고의 흔들림 없는 시선", id: 249961, source: "Lightblinded Vanguard", stats: ["haste","mastery"] },
  { slot: "neck", en: "Ribbon of Coiled Malice", ko: "뒤틀린 악의의 리본", id: 249337, source: "Fallen-King Salhadaar", stats: ["crit","haste"] },
  { slot: "shoulder", en: "Luminant Verdict's Providence Watch", ko: "빛나는 선고의 섭리의 경계", id: 249959, source: "Fallen-King Salhadaar", stats: ["crit","mastery"] },
  { slot: "back", en: "Defiant Defender's Drape", ko: "저항하는 수호자의 외투", id: 260312, source: "Magisters' Terrace", stats: ["crit","haste"] },
  { slot: "chest", en: "Luminant Verdict's Divine Warplate", ko: "빛나는 선고의 신성 전쟁판금", id: 249964, source: "Chimaerus", stats: ["haste","mastery"] },
  { slot: "wrist", en: "Spellbreaker's Bracers", ko: "주문파괴자의 팔보호구", id: 237834, source: "Crafted", stats: [] },
  { slot: "hands", en: "Luminant Verdict's Gauntlets", ko: "빛나는 선고의 건틀릿", id: 249962, source: "Windrunner Spire", stats: ["haste","vers"] },
  { slot: "waist", en: "Luminant Verdict's Undaunted Emblem", ko: "빛나는 선고의 의연한 문장", id: 249958, source: "Catalyst", stats: ["haste","mastery"] },
  { slot: "legs", en: "Luminant Verdict's Greaves", ko: "빛나는 선고의 경갑", id: 249960, source: "Vaelgor & Ezzorak", stats: ["crit","haste"] },
  { slot: "feet", en: "Luminant Verdict's Sabatons", ko: "빛나는 선고의 발덮개", id: 249963, source: "Catalyst", stats: ["haste","mastery"] },
  ...
  { slot: "main_hand", en: "Blood Knight's Mercy", ko: "혈기사의 자비", id: 237848, source: "Crafted", stats: [] },
];
...
export var MYTHIC = [
  ...
  { slot: "main_hand", en: "Garfrost's Two-Ton Hammer", ko: "가프로스트의 2톤 망치", id: 49802, source: "Pit of Saron", stats: ["crit","haste"] },
];

export var ALTS = [
  { forSlot: "chest", id: 151329, en: "Breastplate of the Dark Touch", ko: "어둠의 손길 가슴보호갑", dungeon: "The Great Vault", stats: ["haste","mastery"] },
  ...
  { forSlot: "shoulder", id: 50234, en: "Shoulderplates of Frozen Blood", ko: "얼어붙은 피의 어깨철갑", dungeon: "Pit of Saron", stats: ["crit","mastery"] },
  { forSlot: "hands", id: 151332, en: "Voidclaw Gauntlets", ko: "공허발톱 건틀릿", dungeon: "Seat of the Triumvirate", stats: ["haste","vers"] },
  { forSlot: "waist", id: 151327, en: "Girdle of the Shadowguard", ko: "어둠수호병의 요대", dungeon: "Seat of the Triumvirate", stats: ["haste","mastery"] },
];
...
export var KNOWN_STATS = {
  ...
  51802:["crit","haste"],151327:["haste","mastery"],151328:["crit","haste"],151329:["haste","mastery"],
  151332:["haste","vers"],237834:[],237848:[],249288:["crit","haste"],
  249295:["crit","haste"],249309:["crit","haste"],249332:["haste","mastery"],249337:["crit","haste"],
  249342:[],249343:["mastery"],249369:["haste","mastery"],249920:["haste"],
  249949:["crit","haste"],249951:["crit","haste"],249952:["haste","mastery"],249955:["crit","haste"],
  249958:["haste","mastery"],249959:["crit","mastery"],249960:["crit","haste"],249961:["haste","mastery"],
  249962:["haste","vers"],249963:["haste","mastery"],249964:["haste","mastery"],249969:["crit","mastery"],
  249970:["haste","mastery"],249973:["crit","haste"],250010:["crit","haste"],251081:["crit","haste"],
  251093:["haste","mastery"],251095:["crit","haste"],251107:["haste","mastery"],251111:["crit","haste"],
  251115:["haste","mastery"],251118:["crit","mastery"],251157:["crit","haste"],251162:["crit","haste"],
  251169:["haste","mastery"],251178:["crit","haste"],251217:["crit","haste"],252420:[],
  258525:["crit","haste"],260312:["crit","haste"],260423:["crit","haste"],
};
