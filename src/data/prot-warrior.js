...
export var BIS = [
  { slot: "head", en: "Night Ender's Tusks", ko: "밤의 종결자의 엄니", id: 249952, source: "Tier", stats: ["haste","mastery"] },
  { slot: "neck", en: "Eternal Voidsong Chain", ko: "영원한 공허노래 사슬", id: 249368, source: "Crown of the Cosmos", stats: ["haste","mastery"] },
  { slot: "shoulder", en: "Night Ender's Pauldrons", ko: "밤의 종결자의 견갑", id: 249950, source: "Tier", stats: ["haste","mastery"] },
  { slot: "back", en: "Adherent's Silken Shroud", ko: "신봉자의 비단 수의", id: 239656, source: "Crafted", stats: [] },
  { slot: "chest", en: "Night Ender's Breastplate", ko: "밤의 종결자의 가슴보호갑", id: 249955, source: "Tier", stats: ["crit","haste"] },
...
export var KNOWN_STATS = {
  ...
  249954:["crit","haste"],249955:["crit","haste"],250247:["haste","mastery"],250256:[],
  251081:["crit","haste"],251091:["crit","vers"],251105:["crit","mastery"],251111:["crit","haste"],
  251142:["haste","mastery"],251157:["crit","haste"],251164:["haste","mastery"],251175:["crit","mastery"],
