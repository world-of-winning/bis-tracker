  ...
  return (
    <div style={{ paddingTop: 16, paddingBottom: 24 }}>
      <div style={{ marginBottom: 14 }}>
        ...
        {sr && <button className={"sb" + (raidbotsLit ? " rb-attn" : "")} onClick={openRaidbots} title={!sr.rawSimc ? t("ui.raidbotsReimport") : undefined} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 5, padding: "8px 12px", borderRadius: 8, background: raidbotsLit ? theme.accentBg : "#0c0c16", border: "1px solid " + (raidbotsLit ? theme.accentBorder : "#1e1e30"), fontSize: 11, fontWeight: 600, color: raidbotsLit ? theme.accent : (sr.rawSimc ? "#778888" : "#445555"), whiteSpace: "nowrap", cursor: "pointer", "--rb-glow-lo": theme.accent + "33", "--rb-glow-hi": theme.accent + "77" }}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg>{t("ui.raidbotsCompare")}</button>}
        </div>
        {simcOpen && (
